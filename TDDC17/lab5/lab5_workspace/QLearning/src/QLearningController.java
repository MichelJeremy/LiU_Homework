...
public class QLearningController extends Controller {
	...
	final static int NUM_ACTIONS = 9; /* The takeAction function must be changed if this is modified */
	...
	void performAction(int action) {
		...
		case 5: resetRockets();
				...
				rightEngine.setBursting(true);
				break;
		case 6: leftEngine.setBursting(true);
				rightEngine.setBursting(true);
				middleEngine.setBursting(true);
				break;
		case 7: resetRockets();
	...
	public void tick(int currentTime) {
		iteration++;
		System.out.println(StateAndReward.discretize(angle.getValue(), 11, -3, 3));
		System.out.println(" VX: " + StateAndReward.discretize(vx.getValue(), 5,-10, 10) + " | VY: " + StateAndReward.discretize(vy.getValue(), 15, -10, 10));
		if (!paused) {
